...
export default function AdminAddClassForm() {
  ...
  const handleCancel = () => {
    ...
    router.push('/admin/classmanagement');
  };
        ...
        <div className="">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              {touched.noofstudents && clientErrors.noofstudents && (
                <p className="mt-1.5 text-xs text-error-500">{clientErrors.noofstudents}</p>
              )}
            </div>

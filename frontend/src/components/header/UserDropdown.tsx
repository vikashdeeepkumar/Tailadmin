...
export default function UserDropdown({ isLogin, userData }: UserDropdownProps) {
  const [isOpen, setIsOpen] = useState(false);
    const { profile } = useProfile();
  console.log("userData prop:", userData);
  console.log("userData message:", userData?.message);
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">{profile?.user?.first_name}</span>
